...
class ShelfFilter:
	...
	def _apply_filter(self):
		...
		b=[self.coeficients.b0,self.coeficients.b1,self.coeficients.b2]
		a=[1,self.coeficients.a1,self.coeficients.a2]
		#Output local array
		output=[]
	...
	def _get_coef(self):
		...
		self.coeficients=self._shelf_coef.coeficients
...
class PeakFilter:
	...
	def _get_coef(self):
		...
		self.coeficients=self._peak_coef.coeficients
...
MidPeak2=PeakFilter(fs=fs,fc=400,gain=6,Q=2.0)
