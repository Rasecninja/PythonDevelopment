...
####################### Calling ############################
if(wav_out): wave_file_process("../ExampleMusic/White Noise.wav",b_type+"_"+filter_type+".wav",progress_bar=True,block_size=64,zero_pad=False,stereo=False,pre_proc_func=pre_proc_func,freq_proc_func=None)
